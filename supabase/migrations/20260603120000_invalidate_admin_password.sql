...
-- previously committed hardcoded admin password. Treat that password as
-- leaked if known outside the secure secret store. After this migration runs,
-- the admin password must be rotated
