-- Restore get_profile_stats after community_messages.pinned was dropped by
-- 20260701010000_remove_pinned_messages. The pinned-free redefinition was
-- retro-edited into already-applied migrations (20260612161000, 20260701010000)
-- which never re-run, so the live RPC still referenced the dropped column and
-- errored on every profile view. Forward-only fix; applied to prod 2026-07-02.
